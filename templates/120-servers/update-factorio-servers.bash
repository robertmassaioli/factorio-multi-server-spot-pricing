...
SERVER_STATE_95=${SERVER_STATE_95:-Stopped}
SERVER_STATE_96=${SERVER_STATE_96:-Stopped}
SERVER_STATE_97=${SERVER_STATE_97:-Stopped}
SERVER_STATE_98=${SERVER_STATE_98:-Stopped}
SERVER_STATE_99=${SERVER_STATE_99:-Stopped}
SERVER_STATE_100=${SERVER_STATE_100:-Stopped}
SERVER_STATE_101=${SERVER_STATE_101:-Stopped}
SERVER_STATE_102=${SERVER_STATE_102:-Stopped}
SERVER_STATE_103=${SERVER_STATE_103:-Stopped}
SERVER_STATE_104=${SERVER_STATE_104:-Stopped}
SERVER_STATE_105=${SERVER_STATE_105:-Stopped}
SERVER_STATE_106=${SERVER_STATE_106:-Stopped}
SERVER_STATE_107=${SERVER_STATE_107:-Stopped}
SERVER_STATE_108=${SERVER_STATE_108:-Stopped}
SERVER_STATE_109=${SERVER_STATE_109:-Stopped}
SERVER_STATE_110=${SERVER_STATE_110:-Stopped}
SERVER_STATE_111=${SERVER_STATE_111:-Stopped}
SERVER_STATE_112=${SERVER_STATE_112:-Stopped}
SERVER_STATE_113=${SERVER_STATE_113:-Stopped}
SERVER_STATE_114=${SERVER_STATE_114:-Stopped}
SERVER_STATE_115=${SERVER_STATE_115:-Stopped}
SERVER_STATE_116=${SERVER_STATE_116:-Stopped}
SERVER_STATE_117=${SERVER_STATE_117:-Stopped}
SERVER_STATE_118=${SERVER_STATE_118:-Stopped}
SERVER_STATE_119=${SERVER_STATE_119:-Stopped}
SERVER_STATE_120=${SERVER_STATE_120:-Stopped}
...
RECORD_NAME_95=${RECORD_NAME_95:-""}
RECORD_NAME_96=${RECORD_NAME_96:-""}
RECORD_NAME_97=${RECORD_NAME_97:-""}
RECORD_NAME_98=${RECORD_NAME_98:-""}
RECORD_NAME_99=${RECORD_NAME_99:-""}
RECORD_NAME_100=${RECORD_NAME_100:-""}
RECORD_NAME_101=${RECORD_NAME_101:-""}
RECORD_NAME_102=${RECORD_NAME_102:-""}
RECORD_NAME_103=${RECORD_NAME_103:-""}
RECORD_NAME_104=${RECORD_NAME_104:-""}
RECORD_NAME_105=${RECORD_NAME_105:-""}
RECORD_NAME_106=${RECORD_NAME_106:-""}
RECORD_NAME_107=${RECORD_NAME_107:-""}
RECORD_NAME_108=${RECORD_NAME_108:-""}
RECORD_NAME_109=${RECORD_NAME_109:-""}
RECORD_NAME_110=${RECORD_NAME_110:-""}
RECORD_NAME_111=${RECORD_NAME_111:-""}
RECORD_NAME_112=${RECORD_NAME_112:-""}
RECORD_NAME_113=${RECORD_NAME_113:-""}
RECORD_NAME_114=${RECORD_NAME_114:-""}
RECORD_NAME_115=${RECORD_NAME_115:-""}
RECORD_NAME_116=${RECORD_NAME_116:-""}
RECORD_NAME_117=${RECORD_NAME_117:-""}
RECORD_NAME_118=${RECORD_NAME_118:-""}
RECORD_NAME_119=${RECORD_NAME_119:-""}
RECORD_NAME_120=${RECORD_NAME_120:-""}
...
update_stack() {
    aws cloudformation update-stack \
        ...
        ParameterKey=ServerState95,ParameterValue="$SERVER_STATE_95" \
        ParameterKey=RecordName95,ParameterValue="$RECORD_NAME_95" \
        ParameterKey=ServerState96,ParameterValue="$SERVER_STATE_96" \
        ParameterKey=RecordName96,ParameterValue="$RECORD_NAME_96" \
        ParameterKey=ServerState97,ParameterValue="$SERVER_STATE_97" \
        ParameterKey=RecordName97,ParameterValue="$RECORD_NAME_97" \
        ParameterKey=ServerState98,ParameterValue="$SERVER_STATE_98" \
        ParameterKey=RecordName98,ParameterValue="$RECORD_NAME_98" \
        ParameterKey=ServerState99,ParameterValue="$SERVER_STATE_99" \
        ParameterKey=RecordName99,ParameterValue="$RECORD_NAME_99" \
        ParameterKey=ServerState100,ParameterValue="$SERVER_STATE_100" \
        ParameterKey=RecordName100,ParameterValue="$RECORD_NAME_100" \
        ParameterKey=ServerState101,ParameterValue="$SERVER_STATE_101" \
        ParameterKey=RecordName101,ParameterValue="$RECORD_NAME_101" \
        ParameterKey=ServerState102,ParameterValue="$SERVER_STATE_102" \
        ParameterKey=RecordName102,ParameterValue="$RECORD_NAME_102" \
        ParameterKey=ServerState103,ParameterValue="$SERVER_STATE_103" \
        ParameterKey=RecordName103,ParameterValue="$RECORD_NAME_103" \
        ParameterKey=ServerState104,ParameterValue="$SERVER_STATE_104" \
        ParameterKey=RecordName104,ParameterValue="$RECORD_NAME_104" \
        ParameterKey=ServerState105,ParameterValue="$SERVER_STATE_105" \
        ParameterKey=RecordName105,ParameterValue="$RECORD_NAME_105" \
        ParameterKey=ServerState106,ParameterValue="$SERVER_STATE_106" \
        ParameterKey=RecordName106,ParameterValue="$RECORD_NAME_106" \
        ParameterKey=ServerState107,ParameterValue="$SERVER_STATE_107" \
        ParameterKey=RecordName107,ParameterValue="$RECORD_NAME_107" \
        ParameterKey=ServerState108,ParameterValue="$SERVER_STATE_108" \
        ParameterKey=RecordName108,ParameterValue="$RECORD_NAME_108" \
        ParameterKey=ServerState109,ParameterValue="$SERVER_STATE_109" \
        ParameterKey=RecordName109,ParameterValue="$RECORD_NAME_109" \
        ParameterKey=ServerState110,ParameterValue="$SERVER_STATE_110" \
        ParameterKey=RecordName110,ParameterValue="$RECORD_NAME_110" \
        ParameterKey=ServerState111,ParameterValue="$SERVER_STATE_111" \
        ParameterKey=RecordName111,ParameterValue="$RECORD_NAME_111" \
        ParameterKey=ServerState112,ParameterValue="$SERVER_STATE_112" \
        ParameterKey=RecordName112,ParameterValue="$RECORD_NAME_112" \
        ParameterKey=ServerState113,ParameterValue="$SERVER_STATE_113" \
        ParameterKey=RecordName113,ParameterValue="$RECORD_NAME_113" \
        ParameterKey=ServerState114,ParameterValue="$SERVER_STATE_114" \
        ParameterKey=RecordName114,ParameterValue="$RECORD_NAME_114" \
        ParameterKey=ServerState115,ParameterValue="$SERVER_STATE_115" \
        ParameterKey=RecordName115,ParameterValue="$RECORD_NAME_115" \
        ParameterKey=ServerState116,ParameterValue="$SERVER_STATE_116" \
        ParameterKey=RecordName116,ParameterValue="$RECORD_NAME_116" \
        ParameterKey=ServerState117,ParameterValue="$SERVER_STATE_117" \
        ParameterKey=RecordName117,ParameterValue="$RECORD_NAME_117" \
        ParameterKey=ServerState118,ParameterValue="$SERVER_STATE_118" \
        ParameterKey=RecordName118,ParameterValue="$RECORD_NAME_118" \
        ParameterKey=ServerState119,ParameterValue="$SERVER_STATE_119" \
        ParameterKey=RecordName119,ParameterValue="$RECORD_NAME_119" \
        ParameterKey=ServerState120,ParameterValue="$SERVER_STATE_120" \
        ParameterKey=RecordName120,ParameterValue="$RECORD_NAME_120" \
