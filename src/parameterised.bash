...
Resources:
  ...
  CreateDirectoriesFunction:
    ...
    Properties:
      Description: Creates the initial directories for the EFS drive.
      FunctionName: !Sub "\${AWS::StackName}-create-factorio-directories"
          ...
          def handler(event, context):
              try:
                  if event['RequestType'] in ['Create', 'Update']:
                      ...
                      os.system(f'mount -t nfs4 -o nfsvers=4.1,rsize=1048576,wsize=1048576,hard,timeo=600,retrans=2,noresvport {efs_id}.efs.{os.environ["AWS_REGION"]}.amazonaws.com:/ {mount_path}')
                      ...
                      cfnresponse.send(event, context, cfnresponse.SUCCESS, {'Message': f'Directories created successfully: {", ".join(created_dirs)}'})
